...
$modelLabel = new \backend\models\GameAtvremain();
?>
        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
            <!-- row start search-->
          	<div class="row">
          	<div class="col-sm-12">
                <?php ActiveForm::begin(['id' => 'game-atvremain-search-form', 'method'=>'get', 'options' => ['class' => 'form-inline'], 'action'=>Url::toRoute('game-atvremain/index')]); ?>     
...
<!-- <body></body>后代码块 -->
 ...
 function searchAction(){
		$('#game-atvremain-search-form').submit();
	}

	$(function(){
	    <?php if($dataSet['lineData']):?>
		show_simple_line_chart('#chat-line',<?=json_encode($dataSet['lineData'])?>,'活跃统计','人数');
		<?php endif;?>
		});
</script>
<?php $this->endBlock(); ?>