...
/**
 * This is the model class for table "game_mail_send".
 *
 * @property integer $id
 ...
 */
class GameMailSend extends \backend\models\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
        	...
        	[['record_user','update_user'], 'string', 'max' => 64]
        ];
    }
