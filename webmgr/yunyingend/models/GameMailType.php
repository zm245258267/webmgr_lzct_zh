...
/**
 * This is the model class for table "game_mail_type".
 *
 * @property integer $id
 ...
 */
class GameMailType extends \backend\models\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['title', 'content', 'update_user'], 'required'],
            [['content', 'attach'], 'string'],
            [['update_time'], 'safe'],
            [['title'], 'string', 'max' => 128],
            [['notes'], 'string', 'max' => 255],
            [['update_user'], 'string', 'max' => 64]
        ];
    }
